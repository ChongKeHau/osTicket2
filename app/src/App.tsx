...
function TicketsPlaceholder() {
  // React Router reuses this component instance across sibling routes (/tickets, /tickets/new,
  ...
  // routes still issues a fresh GET /tickets (Task 5+ replace this placeholder with real pages).
